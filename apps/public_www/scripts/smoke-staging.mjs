...
Optional:
  ...
  ${SMOKE_MEDIA_API_BASE_URL_ENV}  Optional media API base URL fallback for /v1/assets/free/request
...
function buildApiCases(turnstileToken) {
  ...
  return [
    ...
    },
    {
      ...
      method: 'POST',
      proxyPath: '/www/v1/assets/free/request',
      directPath: '/v1/assets/free/request',
      apiBaseType: 'media',
      body: {
        first_name: 'Smoke',
        email: smokeEmail,
