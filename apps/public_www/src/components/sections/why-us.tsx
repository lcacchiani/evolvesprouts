  ...
  return (
    ...
    >
      <SectionContainer>
        ...
        >
          <div
            className='relative isolate overflow-hidden rounded-3xl border es-border-soft-alt p-6 es-why-us-hero-card'
          >
            <div
              aria-hidden='true'
            ...
            />
            <div className='relative z-10 flex min-h-size-235 items-end rounded-soft border border-white/70 bg-white/78 p-6 shadow-[0_18px_36px_-30px_rgba(0,0,0,0.55)] sm:min-h-size-360'>
              <Image
                src='/images/evolvesprouts-logo.svg'
                alt=''
                width={74}
                height={74}
                className='h-size-70 w-size-70 rounded-full bg-white p-1'
              />
            </div>
          </div>

          <div className='rounded-3xl border es-border-soft-alt bg-white/85 p-6 sm:p-7'>
        ...
        <p className='es-type-body mt-8 rounded-soft border es-border-soft-alt bg-white/70 p-5 sm:p-6'>
        ...
        <ul className='mt-7 grid grid-cols-1 gap-4 md:grid-cols-2 xl:grid-cols-4'>
          {content.pillars.map((pillar) => (
            <li key={pillar.title}>
              <article className='h-full rounded-soft border es-border-soft-alt es-bg-surface-cream p-5'>
