  ...
  return (
    <div ref={wrapperRef} className='relative flex items-center'>
      ...
      <ul
        ...
        className={`absolute ${menuAlign === 'left' ? 'left-0' : 'right-0'} top-[calc(100%+0.5rem)] z-[70] min-w-size-235 space-y-1 rounded-xl bg-white p-2 shadow-xl transition-opacity duration-200 ease-out ${isBorderlessMenu ? '' : 'border border-black/10'} ${isMenuOpen ? 'pointer-events-auto opacity-100' : 'pointer-events-none opacity-0'}`}
      >
            ...
            <li key={option.locale}>
              ...
              >
                <Image
                  ...
                  width={22}
                  height={22}
                  className='h-size-18 w-size-18 rounded-full object-cover'
                />
