        ...
        <div className='mt-auto space-y-4'>
          ...
          {description && (
            <div className='relative'>
              <span
                aria-hidden='true'
                className={`pointer-events-none absolute inset-x-0 top-0 z-[2] max-w-[calc(34ch-100px)] es-service-card-description es-service-card-description-preview transition-opacity duration-150 group-hover:opacity-0 ${previewVisibilityClassName}`}
              >
