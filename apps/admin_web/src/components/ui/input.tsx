  ...
  return (
    <input
      ...
      className={clsx(
        ...
        isDatePicker &&
          '[&::-webkit-datetime-edit]:p-0 [&::-webkit-datetime-edit-fields-wrapper]:p-0 [&::-webkit-calendar-picker-indicator]:ml-0 [&::-webkit-calendar-picker-indicator]:shrink-0 [&::-webkit-calendar-picker-indicator]:p-0',
        className
      )}
      {...props}
    />
