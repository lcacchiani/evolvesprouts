...
def serialize_service_detail(service: Service) -> dict[str, Any]:
    ...
    if service.training_course_details is not None:
        detail["training_details"] = {
            ...
            "default_price": _decimal_to_string(service.training_course_details.default_price),
            "default_currency": service.training_course_details.default_currency,
        }
    if service.event_details is not None:
        detail["event_details"] = {"event_category": service.event_details.event_category.value}
    if service.consultation_details is not None:
        detail["consultation_details"] = {
            ...
            "default_hourly_rate": _decimal_to_string(service.consultation_details.default_hourly_rate),
            "default_package_price": _decimal_to_string(service.consultation_details.default_package_price),
...
def serialize_instance(instance: ServiceInstance) -> dict[str, Any]:
    ...
    resolved_description = (
        instance.description if instance.description is not None else service.description
    )
    ...
    return {
        ...
        "session_slots": [serialize_session_slot(slot) for slot in instance.session_slots],
        "training_details": (
            {
...
def serialize_enrollment(enrollment: Enrollment) -> dict[str, Any]:
    ...
    return {
        ...
        "ticket_tier_id": str(enrollment.ticket_tier_id) if enrollment.ticket_tier_id else None,
        "discount_code_id": str(enrollment.discount_code_id) if enrollment.discount_code_id else None,
