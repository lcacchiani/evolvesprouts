...
def test_0043_backfill_service_instance_slugs() -> None:
    ...
    with psycopg.connect(conn_url) as conn:
        ...
        conn.execute(
            ...
            (%s, %s, 'MBA 0-1 Apr 26', NULL, NULL, NULL, 'scheduled', NULL, NULL,
             NULL, false, NULL, NULL, NULL, 'test', TIMESTAMPTZ '2026-01-01 00:00:00Z',
             NULL, NULL, 'pending'),
            (%s, %s, 'MBA 1-3 cohort 04-26', NULL, NULL, NULL, 'scheduled', NULL, NULL,
             NULL, false, NULL, '04-26', NULL, 'test', TIMESTAMPTZ '2026-01-01 00:00:00Z',
             NULL, NULL, 'pending'),
            (%s, %s, 'MBA 3-6 May 26', NULL, NULL, NULL, 'scheduled', NULL, NULL,
             NULL, false, NULL, 'may-26', NULL, 'test', TIMESTAMPTZ '2026-01-01 00:00:00Z',
             NULL, NULL, 'pending'),
            (%s, %s, 'Easter 2026 Workshop', NULL, NULL, NULL, 'scheduled', 'in_person', NULL,
            ...
            (%s, %s, 'Easter 2026 Workshop', NULL, NULL, NULL, 'scheduled', 'in_person', NULL,
             10, false, NULL, NULL, NULL, 'test', TIMESTAMPTZ '2026-01-01 00:00:00Z',
             NULL, NULL, 'pending'),
            (%s, %s, NULL, NULL, NULL, NULL, 'scheduled', 'in_person', NULL,
             10, false, NULL, NULL, NULL, 'test', TIMESTAMPTZ '2026-05-10 00:00:00Z',
             NULL, NULL, 'pending'),
            (%s, %s, 'No Slot Title', NULL, NULL, NULL, 'scheduled', 'in_person', NULL,
             10, false, NULL, NULL, NULL, 'test', TIMESTAMPTZ '2026-03-15 12:00:00Z',
             NULL, NULL, 'pending'),
            (%s, %s, 'Consult', NULL, NULL, NULL, 'scheduled', NULL, NULL,
             NULL, false, NULL, NULL, NULL, 'test', TIMESTAMPTZ '2026-01-01 00:00:00Z',
             NULL, NULL, 'pending')
            """,
            (
