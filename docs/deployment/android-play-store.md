...
Check `apps/evolvesprouts/android/app/build.gradle.kts`:
```kotlin
defaultConfig {
...
**Example:** `com.evolvesprouts.evolvesprouts`
...
```bash
cp /path/to/release-keystore.p12 apps/evolvesprouts/android/app/keystore.p12
```
