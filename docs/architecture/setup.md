...
- `CDK_PARAM_MAILCHIMP_MEDIA_JOURNEY_ID` (optional; Mailchimp Customer Journey ID for media download journey trigger)
- `CDK_PARAM_MAILCHIMP_MEDIA_JOURNEY_STEP_ID` (optional; journey step ID for the trigger API)
