...
| `MAILCHIMP_MEDIA_JOURNEY_ID` | Mailchimp Customer Journey ID for `.../journeys/{id}/steps/.../actions/trigger` (empty disables) |
| `MAILCHIMP_MEDIA_JOURNEY_STEP_ID` | Journey step ID paired with `MAILCHIMP_MEDIA_JOURNEY_ID` (empty disables) |
